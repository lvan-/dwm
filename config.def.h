...
static const char col_fg[]          = "#e9e9e9";
static const char col_bg[]          = "#0f0b00";
static const char col_black[]       = "#282828";
static const char col_grey[]        = "#e9e9e9";
static const char col_red[]         = "#da1657";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_fg, "-nf", col_bg, "-sb", col_red, "-sf", col_fg, NULL };
